...
class WindowAttention(nn.Module):
    ...
    def forward(self, x, attn_kv=None, mask=None):
        ...
        # Clamp final pre-softmax logits (after positional bias and mask) to prevent
        # extreme values that destabilise softmax backward and produce NaN gradients
        # in upstream LayerNorm affine parameters.
...
class Uformer(nn.Module):
    ...
    def forward(self, x, mask=None):
        ...
        # Bottleneck
        conv4 = self.conv(pool3, mask=mask) #dim*16
        ...
        up1 = self.upsample_1(deconv0) #dim * 4
